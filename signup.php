<?php
  ...
  // If not register new user and take them to the login page
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $query = "insert into users (user_id, first_name, last_name, telephone,email, password) values ('$user_id', '$first_name', '$last_name', '$telephone', '$email', '$password')";
    ...
    <body id="page-top">
        ...
        <div class="container mt-3 mx-5">
              ...
              <form action="signup.php" method='post'>
                ...
                <div class="mb-3 mt-3">
                  <input type="text" required  class="form-control" id="telephone" placeholder="telephone" name="telephone">
                </div>              
