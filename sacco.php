...
<div class="container mt-3">
  <h3>Choose your preferred sacco</h3>


  <form action="invoice_page.php" method='post'>
    <?php 
        echo  "<input hidden value='$start' type='text' placeholder='$start' name='start'> <br/> <input hidden value='$end' type='text' placeholder='$end' name='end'>";
    ?>
    ...
    <select required class="form-select" id="sacco" name="sacco">
      ...
      <?php 
        $query = "select * from charges where start = '$start' and end = '$end'";
        ...
        if ($result->num_rows > 0) {
          ...
          while($row = $result->fetch_assoc()) {
            ...
            echo "<option value='$sacco'>$sacco @ Ksh $charges</option>";
          }
        } else {
          echo "0 results";
        }
